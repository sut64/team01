 ...
 const requestOptions = {
  ...
  const menu = [
   ...
   /* { name: "ระบบบันทึกรายการพัสดุ", icon: <HomeIcon />, path: "/homecleang" },
    ...
    { name: "บันทึกค่าน้ำค่าไฟ", icon: <AttachMoneyIcon />, path: "/meterrecord" },
    { name: "สร้างบันทึกค่าน้ำค่าไฟ", icon: <AttachMoneyIcon />, path: "/meterrecord/create" },
      ...
      >
        <Toolbar>
         ...
         {/* <img src="/img/postal.png" width="50px"></img>*/}
          <Typography variant="h6" className={classes.title}>
          <h1>ระบบบันทึกค่ารน้ำและค่าไฟฟ้า</h1>
          </Typography>
...
export default NavbarMeterRecord;